...
execute as @a at @s if score @s claim_ids = @e[type=minecraft:armor_stand,tag=claim_center,limit=1] claim_ids run tag @a[tag=!claim_owner,distance=0..5] add claim_trusted
...
#
execute as @a at @s unless score @s claim_ids = @e[type=minecraft:armor_stand,tag=claim_center,limit=1] claim_ids run gamemode survival @s[tag=!claim_owner,tag=claim_trusted]
